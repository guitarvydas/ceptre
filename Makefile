all:
	@./fab/fab rewrite-dollar-simple.ohm rewrite-dollar-simple.fab support.js <test1.cep
	#@./fab/fab rewrite-dollar-simple.ohm rewrite-dollar-simple.fab support.js <dc.cep

identity:
	@./fab/fab rewrite-dollar-simple.ohm identity-ceptre.fab support.js <dc.cep
